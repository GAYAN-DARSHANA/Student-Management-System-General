...
namespace STSD {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("Find_StudentBDS")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class Find_StudentBDS : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected Find_StudentBDS(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            Find_StudentBDS cln = ((Find_StudentBDS)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "Find_StudentBDS";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/Find_StudentBDS.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            Find_StudentBDS ds = new Find_StudentBDS();
...
namespace STSD.Find_StudentBDSTableAdapters {
    ...
    public partial class fStdMasterTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[fStdMaster] ([Autorec], [RegID], [RegCategory], [FullName], [Address], [DOB], [ContactNo], [Guardian], [NameSchool], [SclGrade], [PreDahamScl], [OffGradeAtt], [OffRegDate], [Remarks], [StdStatus_Active], [StdStatus_Resign], [StdStatus_Susp], [StdStatus_Dism], [AddDate], [stdImage], [stdQR]) VALUES (@Autorec, @RegID, @RegCategory, @FullName, @Address, @DOB, @ContactNo, @Guardian, @NameSchool, @SclGrade, @PreDahamScl, @OffGradeAtt, @OffRegDate, @Remarks, @StdStatus_Active, @StdStatus_Resign, @StdStatus_Susp, @StdStatus_Dism, @AddDate, @stdImage, @stdQR);
SELECT Autorec, RegID, RegCategory, FullName, Address, DOB, ContactNo, Guardian, NameSchool, SclGrade, PreDahamScl, OffGradeAtt, OffRegDate, Remarks, StdStatus_Active, StdStatus_Resign, StdStatus_Susp, StdStatus_Dism, AddDate, stdImage, stdQR FROM fStdMaster WHERE (RegID = @RegID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[fStdMaster] SET [Autorec] = @Autorec, [RegID] = @RegID, [RegCategor" +
                ...
                "_Susp, [StdStatus_Dism] = @StdStatus_Dism, [AddDate] = @AddDate, [stdImage] = @s" +
                "tdImage, [stdQR] = @stdQR WHERE (((@IsNull_Autorec = 1 AND [Autorec] IS NULL) OR" +
                " ([Autorec] = @Original_Autorec)) AND ([RegID] = @Original_RegID) AND ((@IsNull_" +
                "RegCategory = 1 AND [RegCategory] IS NULL) OR ([RegCategory] = @Original_RegCate" +
                "gory)) AND ((@IsNull_FullName = 1 AND [FullName] IS NULL) OR ([FullName] = @Orig" +
                "inal_FullName)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] =" +
                " @Original_Address)) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Origi" +
                "nal_DOB)) AND ((@IsNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] =" +
                " @Original_ContactNo)) AND ((@IsNull_Guardian = 1 AND [Guardian] IS NULL) OR ([G" +
                "uardian] = @Original_Guardian)) AND ((@IsNull_NameSchool = 1 AND [NameSchool] IS" +
                " NULL) OR ([NameSchool] = @Original_NameSchool)) AND ((@IsNull_SclGrade = 1 AND " +
                "[SclGrade] IS NULL) OR ([SclGrade] = @Original_SclGrade)) AND ((@IsNull_PreDaham" +
                "Scl = 1 AND [PreDahamScl] IS NULL) OR ([PreDahamScl] = @Original_PreDahamScl)) A" +
                "ND ((@IsNull_OffGradeAtt = 1 AND [OffGradeAtt] IS NULL) OR ([OffGradeAtt] = @Ori" +
                "ginal_OffGradeAtt)) AND ((@IsNull_OffRegDate = 1 AND [OffRegDate] IS NULL) OR ([" +
                "OffRegDate] = @Original_OffRegDate)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS " +
                "NULL) OR ([Remarks] = @Original_Remarks)) AND ((@IsNull_StdStatus_Active = 1 AND" +
                " [StdStatus_Active] IS NULL) OR ([StdStatus_Active] = @Original_StdStatus_Active" +
                ")) AND ((@IsNull_StdStatus_Resign = 1 AND [StdStatus_Resign] IS NULL) OR ([StdSt" +
                "atus_Resign] = @Original_StdStatus_Resign)) AND ((@IsNull_StdStatus_Susp = 1 AND" +
                ...
                " = @Original_StdStatus_Dism)) AND ((@IsNull_AddDate = 1 AND [AddDate] IS NULL) O" +
                "R ([AddDate] = @Original_AddDate)));\r\nSELECT Autorec, RegID, RegCategory, FullNa" +
                "me, Address, DOB, ContactNo, Guardian, NameSchool, SclGrade, PreDahamScl, OffGra" +
                "deAtt, OffRegDate, Remarks, StdStatus_Active, StdStatus_Resign, StdStatus_Susp, " +
                "StdStatus_Dism, AddDate, stdImage, stdQR FROM fStdMaster WHERE (RegID = @RegID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = @"SELECT Autorec, RegID, RegCategory, FullName, Address, DOB, ContactNo, Guardian, NameSchool, SclGrade, PreDahamScl, OffGradeAtt, OffRegDate, Remarks, StdStatus_Active, StdStatus_Resign, StdStatus_Susp, StdStatus_Dism, AddDate, stdImage, stdQR FROM dbo.fStdMaster";
        ...
        public virtual int Fill(Find_StudentBDS.fStdMasterDataTable dataTable) {
        ...
        public virtual Find_StudentBDS.fStdMasterDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            Find_StudentBDS.fStdMasterDataTable dataTable = new Find_StudentBDS.fStdMasterDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Find_StudentBDS.fStdMasterDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(Find_StudentBDS dataSet) {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(Find_StudentBDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(Find_StudentBDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(Find_StudentBDS dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(Find_StudentBDS dataSet) {
            if ((dataSet == null)) {
