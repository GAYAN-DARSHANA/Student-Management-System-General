...
namespace STSD {
    ...
    [global::System.Xml.Serialization.XmlRootAttribute("BPSolutionDataSet1")]
    [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.DataSet")]
    public partial class BPSolutionDataSet1 : global::System.Data.DataSet {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        protected BPSolutionDataSet1(global::System.Runtime.Serialization.SerializationInfo info, global::System.Runtime.Serialization.StreamingContext context) : 
        ...
        public override global::System.Data.DataSet Clone() {
            BPSolutionDataSet1 cln = ((BPSolutionDataSet1)(base.Clone()));
            cln.InitVars();
        ...
        private void InitClass() {
            this.DataSetName = "BPSolutionDataSet1";
            this.Prefix = "";
            this.Namespace = "http://tempuri.org/BPSolutionDataSet1.xsd";
        ...
        public static global::System.Xml.Schema.XmlSchemaComplexType GetTypedDataSetSchema(global::System.Xml.Schema.XmlSchemaSet xs) {
            BPSolutionDataSet1 ds = new BPSolutionDataSet1();
...
namespace STSD.BPSolutionDataSet1TableAdapters {
    ...
    public partial class fStdMasterTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[fStdMaster] ([Autorec], [RegID], [RegCategory], [FullName], [Address], [DOB], [ContactNo], [Guardian], [NameSchool], [SclGrade], [PreDahamScl], [OffGradeAtt], [OffRegDate], [Remarks], [StdStatus_Active], [StdStatus_Resign], [StdStatus_Susp], [StdStatus_Dism], [AddDate], [stdImage]) VALUES (@Autorec, @RegID, @RegCategory, @FullName, @Address, @DOB, @ContactNo, @Guardian, @NameSchool, @SclGrade, @PreDahamScl, @OffGradeAtt, @OffRegDate, @Remarks, @StdStatus_Active, @StdStatus_Resign, @StdStatus_Susp, @StdStatus_Dism, @AddDate, @stdImage);
SELECT Autorec, RegID, RegCategory, FullName, Address, DOB, ContactNo, Guardian, NameSchool, SclGrade, PreDahamScl, OffGradeAtt, OffRegDate, Remarks, StdStatus_Active, StdStatus_Resign, StdStatus_Susp, StdStatus_Dism, AddDate, stdImage FROM fStdMaster WHERE (RegID = @RegID)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[fStdMaster] SET [Autorec] = @Autorec, [RegID] = @RegID, [RegCategor" +
                ...
                "tdImage WHERE (((@IsNull_Autorec = 1 AND [Autorec] IS NULL) OR ([Autorec] = @Ori" +
                "ginal_Autorec)) AND ([RegID] = @Original_RegID) AND ((@IsNull_RegCategory = 1 AN" +
                "D [RegCategory] IS NULL) OR ([RegCategory] = @Original_RegCategory)) AND ((@IsNu" +
                ...
                ")) AND ((@IsNull_DOB = 1 AND [DOB] IS NULL) OR ([DOB] = @Original_DOB)) AND ((@I" +
                "sNull_ContactNo = 1 AND [ContactNo] IS NULL) OR ([ContactNo] = @Original_Contact" +
                "No)) AND ((@IsNull_Guardian = 1 AND [Guardian] IS NULL) OR ([Guardian] = @Origin" +
                "al_Guardian)) AND ((@IsNull_NameSchool = 1 AND [NameSchool] IS NULL) OR ([NameSc" +
                "hool] = @Original_NameSchool)) AND ((@IsNull_SclGrade = 1 AND [SclGrade] IS NULL" +
                ") OR ([SclGrade] = @Original_SclGrade)) AND ((@IsNull_PreDahamScl = 1 AND [PreDa" +
                "hamScl] IS NULL) OR ([PreDahamScl] = @Original_PreDahamScl)) AND ((@IsNull_OffGr" +
                "adeAtt = 1 AND [OffGradeAtt] IS NULL) OR ([OffGradeAtt] = @Original_OffGradeAtt)" +
                ") AND ((@IsNull_OffRegDate = 1 AND [OffRegDate] IS NULL) OR ([OffRegDate] = @Ori" +
                "ginal_OffRegDate)) AND ((@IsNull_Remarks = 1 AND [Remarks] IS NULL) OR ([Remarks" +
                "] = @Original_Remarks)) AND ((@IsNull_StdStatus_Active = 1 AND [StdStatus_Active" +
                "] IS NULL) OR ([StdStatus_Active] = @Original_StdStatus_Active)) AND ((@IsNull_S" +
                "tdStatus_Resign = 1 AND [StdStatus_Resign] IS NULL) OR ([StdStatus_Resign] = @Or" +
                "iginal_StdStatus_Resign)) AND ((@IsNull_StdStatus_Susp = 1 AND [StdStatus_Susp] " +
                "IS NULL) OR ([StdStatus_Susp] = @Original_StdStatus_Susp)) AND ((@IsNull_StdStat" +
                "us_Dism = 1 AND [StdStatus_Dism] IS NULL) OR ([StdStatus_Dism] = @Original_StdSt" +
                "atus_Dism)) AND ((@IsNull_AddDate = 1 AND [AddDate] IS NULL) OR ([AddDate] = @Or" +
                "iginal_AddDate)));\r\nSELECT Autorec, RegID, RegCategory, FullName, Address, DOB, " +
                "ContactNo, Guardian, NameSchool, SclGrade, PreDahamScl, OffGradeAtt, OffRegDate," +
                " Remarks, StdStatus_Active, StdStatus_Resign, StdStatus_Susp, StdStatus_Dism, Ad" +
                "dDate, stdImage FROM fStdMaster WHERE (RegID = @RegID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Autorec, RegID, RegCategory, FullName, Address, DOB, ContactNo, Guardian, " +
                ...
                "ctive, StdStatus_Resign, StdStatus_Susp, StdStatus_Dism, AddDate, stdImage FROM " +
                "dbo.fStdMaster";
        ...
        public virtual int Fill(BPSolutionDataSet1.fStdMasterDataTable dataTable) {
        ...
        public virtual BPSolutionDataSet1.fStdMasterDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            BPSolutionDataSet1.fStdMasterDataTable dataTable = new BPSolutionDataSet1.fStdMasterDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BPSolutionDataSet1.fStdMasterDataTable dataTable) {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(BPSolutionDataSet1 dataSet) {
        ...
        public virtual int Update(
            ...
            if ((Original_Guardian == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[34].Value = ((string)(Original_Guardian));
            }
            if ((Original_NameSchool == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[36].Value = ((string)(Original_NameSchool));
            }
            if ((Original_SclGrade == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[38].Value = ((string)(Original_SclGrade));
            }
            if ((Original_PreDahamScl == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[40].Value = ((string)(Original_PreDahamScl));
            }
            if ((Original_OffGradeAtt == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[42].Value = ((string)(Original_OffGradeAtt));
            }
            if ((Original_OffRegDate.HasValue == true)) {
            ...
            if ((Original_StdStatus_Active.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[48].Value = ((bool)(Original_StdStatus_Active.Value));
            }
            else {
            ...
            if ((Original_StdStatus_Resign.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[50].Value = ((bool)(Original_StdStatus_Resign.Value));
            }
            else {
            ...
            if ((Original_StdStatus_Susp.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[52].Value = ((bool)(Original_StdStatus_Susp.Value));
            }
            else {
            ...
            if ((Original_StdStatus_Dism.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[54].Value = ((bool)(Original_StdStatus_Dism.Value));
            }
            else {
            ...
            if ((Original_AddDate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[56].Value = ((System.DateTime)(Original_AddDate.Value));
            }
            else {
    ...
    public partial class TableAdapterManager : global::System.ComponentModel.Component {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateUpdatedRows(BPSolutionDataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateInsertedRows(BPSolutionDataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allAddedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        private int UpdateDeletedRows(BPSolutionDataSet1 dataSet, global::System.Collections.Generic.List<global::System.Data.DataRow> allChangedRows) {
            int result = 0;
            if ((this._fStdMasterTableAdapter != null)) {
        ...
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        public virtual int UpdateAll(BPSolutionDataSet1 dataSet) {
            if ((dataSet == null)) {
